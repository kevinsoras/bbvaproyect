...
<body>
	<div id="cuerpo">
		<div id="titulo">
			<p id="letra1" class="titulo">BBVA</p>
			<p id="letra2" class="titulo" >Continental</p>
		</div>
		<div id="cuerpito">
			...
			<button id="retroceder" class="boton">Retroceder</button>
			<button id="imprimir" class="boton">Imprimir</button>
		</div>
	</div>
	<div id="tirasuperior">
		<div id="t1"></div>
