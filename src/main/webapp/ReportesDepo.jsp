...
<link rel="stylesheet"
	...
	<link rel="stylesheet" type="style/css"	href="css/impresion.css" media="print">
...
<body>
	<div id="cuerpo">
		<div id="titulo">
			<p class="titulo" id="letra1">BBVA</p>
			<p class="titulo" id="letra2">Continental</p>
		</div>
		<div id="cuerpito">
			<h1 id="letra">Movimientos:</h1>
			<table id="tblMovi" class="table">
